    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
          ...
          <a href="https://x.com/harshsingh" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@harshsingh</span>
          </a>
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <a class="mobile-menu-item" href="https://x.com/harshsingh" target="_blank" rel="noopener">
          ...
          <span class="mobile-menu-item-label">@harshsingh</span>
        </a>
        <div class="mobile-menu-divider"></div>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            ...
            <span class="site-footer-sub">by Harshsingh</span>
          </div>
        </div>
        <nav>
